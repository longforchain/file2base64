...
public class File2Base64 extends CordovaPlugin {
	...
	public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
		if ("encode".equals(action)) {
			...
			try {
				...
				if (parameters != null) {
					String base64String = encodeFile(parameters.getString("location"));
	...
	private String encodeFile(String filePath) {
        ...
        try {
            ...
            String subfix = filePath.substring(index+1,filePath.length());
            String contentType = MIMEType.getContentTypeOfSuffix(subfix);
